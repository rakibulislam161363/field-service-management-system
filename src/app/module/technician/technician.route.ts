...
router.get("/", auth("CUSTOMER", "TECHNICIAN", "MANAGER", "ADMIN"), TechnicianController.getAllTechnicians);
router.get("/:id", auth("CUSTOMER", "TECHNICIAN", "MANAGER", "ADMIN"), TechnicianController.getSingleTechnician);
...
router.delete("/:id/skills/:skillId", auth("TECHNICIAN", "MANAGER", "ADMIN"), TechnicianController.removeSkill);
